...
const PROFILE_FIELDS = [
  ...
  { key: "annee_bac", label: "Année du bac" },
  { key: "serie_bac", label: "Série du bac" },
  { key: "moyenne_bac", label: "Moyenne générale" },
  { key: "numero_inscription_bac", label: "Numéro d'inscription au bac" },
];
