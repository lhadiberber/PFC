    ...
    <div className="page">
      ...
      <form onSubmit={handleSubmit} className="form">
        ...
        <div className="actions">
          <button type="button" className="retour-btn" onClick={() => navigate("/dashboard")}>Retour</button>
      ...
      {showRecapitulatif && (
        <div className="recapitulatif-section">
          ...
          <div className="recap-actions">
            <button type="button" className="valider-btn" onClick={() => navigate("/success")}>Valider la candidature</button>
          </div>
        </div>
      )}
    </div>
