const en = {
  ...
  auth: {
    ...
    register: {
      ...
      helper: "Fields marked with an asterisk are required.",
      sections: {
      ...
      successMessage: "Account created successfully. You can sign in.",
      footerText: "Already have an account?",
      footerLink: "Sign in",
      errors: {
        nomRequired: "Please enter your last name.",
        prenomRequired: "Please enter your first name.",
        invalidEmail: "Please enter a valid email address.",
        ...
        tooManyAttempts: "Please wait before trying again.",
        backendUnavailable:
          "Unable to contact the server. Check that the backend is running.",
        createFailed: "Unable to create the account right now.",
      },
    },
  },
  success: {
