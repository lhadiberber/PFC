const fr = {
  ...
  auth: {
    ...
    register: {
      ...
      introTitle: "Un espace clair et sécurisé pour préparer votre candidature.",
      introDescription:
        "Créez votre compte pour compléter votre profil, centraliser vos documents et suivre vos démarches dans un parcours simple et rassurant.",
      highlights: [
        {
        ...
        },
        {
          ...
          description: "Retrouvez vos candidatures et vos pièces en temps réel.",
        },
        {
          title: "Plateforme sécurisée",
          description:
            "Vos informations restent associées à votre compte personnel.",
        },
      ],
      badge: "Inscription",
      title: "Créer un compte",
      subtitle: "Inscrivez-vous pour candidater",
      helper: "Les champs marqués d'un astérisque sont obligatoires.",
      sections: {
      ...
      errors: {
        nomRequired: "Veuillez renseigner votre nom.",
        prenomRequired: "Veuillez renseigner votre prénom.",
        invalidEmail: "Veuillez saisir une adresse e-mail valide.",
        ...
        tooManyAttempts: "Veuillez patienter avant de réessayer.",
        backendUnavailable:
          "Impossible de contacter le serveur. Vérifiez que le backend est lancé.",
        createFailed: "Impossible de créer le compte pour le moment.",
      },
    },
  },
  success: {
