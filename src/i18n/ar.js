const ar = {
  ...
  home: {
    ...
    programs: {
      ...
      subtitle: "اختر تكويناً يناسب مستواك ومشروعك الدراسي.",
      items: [
        {
          level: "ليسانس",
          title: "العلوم والتكنولوجيا",
          description: "مسارات في الإعلام الآلي والرياضيات والفيزياء وعلوم الهندسة.",
        },
        {
          level: "ليسانس / ماستر",
          title: "الاقتصاد والتسيير",
          description: "تكوينات في الاقتصاد والتسيير والمالية والتجارة.",
        },
        {
          level: "ماستر",
          title: "الصحة وعلوم الحياة",
          description: "مسارات مرتبطة بالبيولوجيا والصحة العمومية والعلوم الطبية.",
        },
      ],
    },
    calendar: {
    ...
    footer: {
      ...
      columns: [
        {
          title: "المنصة",
          links: ["الرئيسية", "الجامعات", "التخصصات", "المساعدة"],
        },
        {
          title: "الأسئلة الشائعة",
          links: ["اتصل بنا", "الدعم"],
        },
        {
          title: "قانوني",
      ...
      infoSections: [
        {
          ...
          title: "اتصل بنا",
          description:
            "لأي سؤال حول ملفك، يمكنك التواصل مع مصلحة القبول في مؤسستك.",
        },
        {
          id: "mentions-legales",
          title: "إشعارات قانونية",
          description:
            "تم إنجاز هذه المنصة في إطار مشروع نهاية الدراسة، وتهدف إلى تسهيل تسيير القبول الجامعي.",
        },
        {
          id: "confidentialite",
          title: "الخصوصية",
          description:
            "تستعمل المعلومات المدخلة فقط لمتابعة الترشحات وتسيير الملفات.",
        },
        {
          id: "cgu",
          title: "الشروط",
  ...
  auth: {
    ...
    register: {
      ...
      helper: "الحقول التي تحتوي على نجمة إجبارية.",
      sections: {
      ...
      submit: "إنشاء حسابي",
      submitting: "جار إنشاء الحساب...",
      successMessage: "تم إنشاء الحساب بنجاح. يمكنك تسجيل الدخول.",
      ...
      errors: {
        ...
        emailUsed: "هذا البريد الإلكتروني مستعمل من قبل.",
        tooManyAttempts: "يرجى الانتظار قبل المحاولة مرة أخرى.",
        backendUnavailable:
          "تعذر الاتصال بالخادم. تأكد من تشغيل الواجهة الخلفية.",
        createFailed: "تعذر إنشاء الحساب حالياً.",
      },
    },
  },
  success: {
